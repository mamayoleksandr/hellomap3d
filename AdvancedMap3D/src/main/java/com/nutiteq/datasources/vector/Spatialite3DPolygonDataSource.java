 ...
 *
 */
public abstract class Spatialite3DPolygonDataSource extends AbstractVectorDataSource<Polygon3D> {
     ...
     * @throws IOException 
     */
    public Spatialite3DPolygonDataSource(Projection proj, String dbPath, String tableName, String geomColumnName, String[] userColumns, String filter) throws IOException {
     ...
     */
    public Spatialite3DPolygonDataSource(Projection proj, SpatialLiteDbHelper spatialLiteDb,
    ...
    @Override
    public Collection<Polygon3D> loadElements(final CullState cullState) {
        if (dbLayer == null) {
            return null;
        }
        ...
        GeometryFactory geomFactory = new GeometryFactory() {
            ...
            public Point createPoint(MapPos mapPos, Object userData) {
                ...
                return new Point(mapPos, label, (PointStyle) null, userData);
            }
            ...
            public Line createLine(List<MapPos> points, Object userData) {
                Label label = createLabel((Map<String, String>) userData);
                return new Line(points, label, (LineStyle) null, userData);
            }
            ...
            public Polygon createPolygon(List<MapPos> outerRing, List<List<MapPos>> innerRings, Object userData) {
                Label label = createLabel((Map<String, String>) userData);
                return new Polygon(outerRing, innerRings, label, (PolygonStyle) null, userData);
            }
        ...
        // Perform the query
        List<Polygon3D> elements3D = new ArrayList<Polygon3D>();
        ...
        for (Geometry element : elements) {
            ...
            Polygon3D polygon3D = createManHole(point.getMapPos(), (Map<String, String>) element.userData);
            
//            element.attachToDataSource(this);
            polygon3D.attachToDataSource(this);
            
            elements3D.add(polygon3D);
        }
    ...
    protected abstract Polygon3D createManHole(MapPos mapPos, Map<String, String> userData);
