...
public class UTFGridLayerEventListener extends MapListener {
    ...
    private UTFGridRasterLayer layer;
    private String template;
    private Marker clickMarker;
    private MapView mapView;

    // activity is often useful to handle click events
    public UTFGridLayerEventListener(Activity activity, MapView mapView, UTFGridRasterLayer layer, Marker clickMarker) {
    ...
    public UTFGridRasterLayer getLayer() {
        return layer;
    }
